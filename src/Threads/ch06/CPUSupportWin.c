...
JNIEXPORT jint JNICALL Java_CPUSupport_getNumProcessorsN(JNIEnv *env, jobject cls)
{
...
JNIEXPORT void JNICALL Java_CPUSupport_setConcurrencyN(JNIEnv *env, jobject cls, jint kthreads)
{
	// For Windows the concurrency is always infinity.
	return;
}

JNIEXPORT jint JNICALL Java_CPUSupport_getConcurrencyN(JNIEnv *env, jobject cls)
{
