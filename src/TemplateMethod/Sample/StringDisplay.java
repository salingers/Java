...
{ // StringDisplay也是AbstractDisplay的子類別。
	...
	{ // 把以建構子傳遞過來的字串string
		...
		this.width = string.getBytes().length; // 接著把以byte為單位的字元寬幅也先儲存在欄位，後面還會使用到。
	}
	...
	public void print()
	{ // print方法則在
		System.out.println("|" + string + "|"); // 欄位所儲存的字串前後加上"|"，然後輸出到畫面上。
	}
	...
	{ // 這是open和close所呼叫的printLine方法。因為這是private，所以只能在此類別內使用。
